...
public class ZoomableLineChart extends Application {
    ...
    private void doZoom(Rectangle zoomRect, LineChart<Number, Number> chart) {
        ...
        Point2D zoomTopLeftScene = zoomRect.localToScene(zoomTopLeft.getX(),zoomTopLeft.getY());
        Point2D zoomBottomRightScene = zoomRect.localToScene(zoomBottomRight.getX(), zoomBottomRight.getY());
        ...
        Point2D minXDisplay = xAxis.sceneToLocal(zoomTopLeftScene);
        Point2D maxXDisplay = xAxis.sceneToLocal(zoomBottomRightScene);
    
        Number xLowerBound = xAxis.getValueForDisplay(minXDisplay.getX());
        Number xUpperBound = xAxis.getValueForDisplay(maxXDisplay.getX());
    
        xAxis.setLowerBound( xLowerBound.doubleValue() );
        xAxis.setUpperBound( xUpperBound.doubleValue() );
    
        Point2D maxYDisplay = yAxis.sceneToLocal(zoomTopLeftScene);
        Point2D minYDisplay = yAxis.sceneToLocal(zoomBottomRightScene);
    
        Number yLowerBound = yAxis.getValueForDisplay(minYDisplay.getY());
        Number yUpperBound = yAxis.getValueForDisplay(maxYDisplay.getY());
